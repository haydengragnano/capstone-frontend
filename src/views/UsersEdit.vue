    ...
    <div class="col-md-7 col-lg-8 col-xl-8">
      ...
      <form v-on:submit.prevent="updateUser()">
        ...
        <div class="form-group">
          ...
          <input type="text" v-model="user.stream_url" class="form-control form-control-lg" placeholder="Website url" />
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label>TAGS</label>
            <div v-for="tag in tags" v-bind:key="tag.id" class="form-control form-control-sm">
      ...
      <div class="form-group action">
        <button v-on:click="destroyUser()" class="btn btn-lg btn-primary">Delete</button>
      </div>
    </div>
    <!-- <h1>Edit User</h1>
    <form v-on:submit.prevent="updateUser()">
